...
function submitWord(word) {
    ...
    if (checkWord(word)) {
        ...
        wordData.correct += 1;
        StreamWordsConfig.trigger('onCorrectType');
    } else {
...
function typingTest(e) {
    ...
    if (word.value.match(/^\s/g)) {
        ...
        if (!StreamWordsConfig.trigger('checkStop')) {
          ...
          StreamWordsConfig.trigger('onStop');
        }
    }
}

StreamWords.onType = typingTest;
StreamWords.addWords = addWords;
